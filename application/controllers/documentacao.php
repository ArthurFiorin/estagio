...

{
  ...
  public function alterarDoc()
  {
	...
	public function apagarDoc()
  {
    $json = file_get_contents('php://input');
    $resultado = json_decode($json);

    $lista = array(
      "ra" => '0', "usuario" => '0', "senha" => '0');
    ...
    if (verificarParam($resultado, $lista) == 1) {
      ...
      $senha = $resultado->senha;
        ...
        $retorno = $this->M_documentacao->apagarDoc($this->getRA(), $usuario, $senha);
      }
    } else {
      $retorno = array('codigo' => 99, 'msg' => 'os campos vindos do front nao representam o método de inserçao');
    }
  ...
  public function ativarDoc()
  {
    ...
    if (verificarParam($resultado, $lista) == 1) {
      ...
      if (trim($this->getRA()) == 0) {
        ...
        $retorno = $this->M_documentacao->ativarDoc($this->getRA());
      }
    } else {
